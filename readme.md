# TPS S2E6 <!-- omit in toc -->
## Missing Value Imputation <!-- omit in toc -->
...
Since the missing values are randomly distributed as well as groups F_1_x and F_3_x being independent, the imputation method that should give the best results is a simple imputation using the mean. This is due to the fact that when you minimize the derivative of RMSE it yields the mean. Here we must assume that the training/validation mean is the same, or at least very close, to the test mean.
